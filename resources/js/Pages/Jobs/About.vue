...
const posts = [
  {
    id: 1,
    title: 'Title: Finding Success in the Job Board Market: A Comprehensive Guide',
    href: '#',
    description:
      'Laravel, a powerful PHP framework, provides developers with the tools and flexibility to build robust web applications. In this blog, we will walk you through the process of creating a job board using Laravel. Whether you are a seasoned Laravel developer or just getting started, this guide will help you understand the key components and steps involved in building a successful job board platform.',
    date: 'May 11, 2023',
    datetime: '2023-05-11',
    category: { title: 'Tech', href: '#' },
    author: {
      name: 'Worawut Wattana',
      role: 'Developer',
      href: '#',
      imageUrl:
        'https://avatars.githubusercontent.com/u/15034021?v=4',
    },
  },
  // More posts...
]
